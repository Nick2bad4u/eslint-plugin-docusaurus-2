...
| [`require-balanced-footer-link-columns`](https://nick2bad4u.github.io/eslint-plugin-docusaurus-2/docs/rules/require-balanced-footer-link-columns) | — | [🧪](./experimental.md) |
...
| [`require-markdown-format-detect`](https://nick2bad4u.github.io/eslint-plugin-docusaurus-2/docs/rules/require-markdown-format-detect) | 🔧 | [🔵](./config.md) [🟡](./recommended.md) [🔴](./strict.md) [🟣](./all.md) [🧪](./experimental.md) |
