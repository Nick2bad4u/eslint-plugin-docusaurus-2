...
Like `all`, it currently includes the stable shipped rules—including all four owned Docusaurus link, heading, and translation rules—plus the current experimental rollout surface for Docusaurus page-module and site-architecture checks.
