...
const config = {
    ...
    tagline:
        "High-signal ESLint rules for Docusaurus sites, pages, sidebars, and TypeDoc-integrated docs.",
    themeConfig: {
        colorMode: {
            defaultMode: "dark",
            disableSwitch: false,
            ...
            links: [
                ...
                },
                {
                    items: [
                        ...
                        {
                            href: "https://github.com/Nick2bad4u/eslint-plugin-typedoc",
                            label: "\u{F113} eslint-plugin-typedoc",
                        },
                        {
                            href: "https://www.npmjs.com/package/eslint-plugin-typedoc",
                            label: "\u{E65B} eslint-plugin-typedoc",
                        },
                    ],
                    title: "📁 Project",
                },
        ...
        metadata: [
            {
                content:
                    "eslint, eslint-plugin, docusaurus, typedoc, documentation, sidebars, pages, static analysis",
                name: "keywords",
            },
            {
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            label: "• Config & setup rules",
                            to: "/docs/rules/no-deprecated-on-broken-markdown-links",
                        },
                        {
                            label: "• Sidebar rules",
                            to: "/docs/rules/require-doc-sidebar-link-type",
                        },
                        {
                            label: "• Pages & site rules",
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            href: "https://github.com/Nick2bad4u/eslint-plugin-typedoc",
                            label: "📘 \u{E709} eslint-plugin-typedoc",
                        },
                        {
                            href: "https://www.npmjs.com/package/eslint-plugin-typedoc",
                            label: "📘 \u{E616} eslint-plugin-typedoc",
                        },
                    ],
                    label: "\u{E65B} GitHub",
                    position: "right",
